          ...
          <div class="layui-col-xs12 layui-col-sm12 layui-col-md8">
            <div class="main">
              ...
              <div class="article">
                ...
                <div class="img-box"><img onclick="javascript:window.open(this.src)" src="@/assets/res/static/images/news_imgbig.jpg"></div>
              ...
              <div class="leave-message" id="message">
                ...
                <div class="content-box">
                  <div class="tear-box">
                    <a href="#"><img src="@/assets/res/static/images/header_img1.png"></a>
